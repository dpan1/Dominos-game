...
class Proportions:
    # Holds display variables, and calculates dependent proportions. I don't think this is how you're supposed to do this
    # but it works, it's quick, and I don't have to think too much about it.
    def __init__(self, window_width=1024, window_height=640):
        ...
        self.BOARD_CENTER = self.BOARD_HEIGHT // 2, self.WINDOW_WIDTH // 2
